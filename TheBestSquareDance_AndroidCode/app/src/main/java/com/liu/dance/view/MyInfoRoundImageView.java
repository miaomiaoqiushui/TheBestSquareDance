...
public class MyInfoRoundImageView extends ImageView {
    ...
    public MyInfoRoundImageView(Context context) {
        super(context);
        mContext = context;
    }

    public MyInfoRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public MyInfoRoundImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Bitmap RoundBitmap(Bitmap bitmap) {
        ...
        try {
            resultBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_4444);
        } catch (Throwable e) {
            e.printStackTrace();
        }
