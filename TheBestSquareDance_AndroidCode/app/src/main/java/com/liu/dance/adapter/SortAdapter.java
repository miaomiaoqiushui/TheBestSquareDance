...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.layout_dance_friend_item, null);
        ...
        // 头像采用imageloader加载
        viewHolder.sex.setImageResource(model.getSex() == 0 ? R.drawable.ic_boy1
                : R.drawable.ic_girl1);
