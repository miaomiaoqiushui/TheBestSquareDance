...
public class MyDownloadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView video_download_back = (TextView) findViewById(R.id.btn_video_download_back);
        video_download_back.setOnClickListener(new View.OnClickListener() {
        ...
        initVideos();
        adapter = new ListAdapter(MyDownloadActivity.this, R.layout.layout_collection_item, videoList);
        ListView listView = (ListView) findViewById(R.id.download_video);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(!isNeedChecked)
                    Toast.makeText(MyDownloadActivity.this, video.getName(), Toast.LENGTH_SHORT).show();
                else {
                    if(!video.isChecked())
        ...
        select = (LinearLayout) findViewById(R.id.am_download_select);
        all_select = (TextView) findViewById(R.id.am_download_all_select);
        all_edit = (TextView) findViewById(R.id.am_download_edit);


        edit_video = (TextView)findViewById(R.id.edit_download);
    ...
    private void initVideos() {
        for(int i = 0;i < 4;i++) {
            ListVideo video = new ListVideo("视频名称："+ VideoConstant.videoTitles[2][i], VideoConstant.videoThumbs[2][i], false);
            videoList.add(video);
        }
    }
}
