...
import com.liu.dance.view.SelectRemindCyclePopup;
import com.liu.dance.view.SelectRemindWayPopup;
...
public class TimeServiceActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView time_service_back = (TextView) findViewById(R.id.btn_timeservice_back);
        time_service_back.setOnClickListener(new View.OnClickListener() {
